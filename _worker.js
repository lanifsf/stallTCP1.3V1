      ...
      if (url.pathname === '/sub') {
          ...
          if (baseLink) {
              ...
              const links = allIPs.map(ipInfo => {
                  ...
                  let ip = addrPart, port = '443';
                  if (addrPart.includes(':') && !addrPart.startsWith('[')) {
